...
import CreateForm from '@/components/ExamCategoryCreateForm/CreateForm';
import UpdateForm from '@/components/ExamCategoryUpdateForm/UpdateForm';
  ...
  const columns: ColumnsType<DepartmentModel> = [
    {
      ...
      dataIndex: '',
      width: 300,
      render: (_, record) => <CheckboxGroup options={plainOptions} value={checkedList} onChange={onChange} />,
    },
    {
      title: 'STT',
      dataIndex: 'index',
